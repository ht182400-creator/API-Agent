...
### 3.1 P1-4 巨型文件拆分 🔄（后端 4/4 ✅；前端 3/4 已完成：`Analytics` · `admin/Repos` · `owner/Repos`，仅剩 `Recharge`（拆分中 2001→1571）｜详见 §2.25）
